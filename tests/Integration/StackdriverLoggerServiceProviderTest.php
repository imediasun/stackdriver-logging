...
use Devmagellan\StackdriverLogging\Handler\StackdriverLoggingHandler;
use Devmagellan\StackdriverLogging\LoggerInterface;
use Devmagellan\StackdriverLogging\StackdriverLogger;
use Devmagellan\StackdriverLogging\StackdriverLoggerServiceProvider;
...
class StackdriverLoggerServiceProviderTest extends TestCase
{
    ...
    public function it_can_be_registered_as_log_channel()
    {
        config(['logging.channels.stackdriver' => [
            'driver' => 'monolog',
            'handler' => Devmagellan\StackdriverLogging\Handler\StackdriverLoggingHandler::class
        ]]);
